...
/* Set this to 1 if you want onDataFromPCtoDevice() to be called for control-out
 ...
 * You must implement the function onDataFromPCtoDeviceOut() which receives all
 ...
 * implement the filtering yourself in onDataFromPCtoDeviceOut() and
 * onDataFromPCtoDevice(). Use the global usbCurrentDataToken and a static variable
 ...
 */
#define USB_CFG_VENDOR_NAME 'a', 'r', 'd', 'u', 'i', 'n ', 'o', '_', 'u', 's', 'b', '_', 'l', 'i', 'n', 'u', 'x'
